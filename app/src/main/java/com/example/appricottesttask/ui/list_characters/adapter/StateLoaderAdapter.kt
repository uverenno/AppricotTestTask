...
import com.example.appricottesttask.databinding.ItemErrorBinding
import com.example.appricottesttask.databinding.ItemProgressBinding

class StateLoaderAdapter() : LoadStateAdapter<StateLoaderAdapter.ItemViewHolder>() {
    ...
    class ProgressViewHolder internal constructor(
        ...
        override fun bind(loadState: LoadState) {
            // progress bar crutitsya laveha mutitsya
        }
